...
We are ParkRocket LLC, doing business as DoublePark ("**Company**," "**we**," "**us**," "**our**"), a company registered in Utah, United States at 7533 C Center View Ct Ste N, West Jordan, UT 84084.

We operate the mobile application DoublePark (the "**App**"), as well as any other related products and services that refer or link to these legal terms (the "**Legal Terms**") (collectively, the "**Services**").
...
We will provide you with prior notice of any scheduled changes to the Services you are using. Changes to these Legal Terms will become effective seven (7) days after the notice is given, except if the changes apply to new functionality, security updates, and bug fixes, in which case the changes will be effective immediately. By continuing to use the Services after the effective date of any changes, you agree to be bound by the modified terms. If you disagree with such changes, you may terminate Services as per the section "[TERM AND TERMINATION](#14-term-and-termination)."
...
24. [SMS TEXT MESSAGING](#24-sms-text-messaging)
...
* Copy or adapt the Services' software, including but not limited to Flash, PHP, HTML, JavaScript, Python, or other code.
...
* Misrepresent your location or parking spot availability.
* Use the platform to reserve spots with no intent to complete the transaction.
* Accept payment for a parking spot without completing a handoff or giving away the parking spot you occupied.
* Cancel a transaction after receiving the parking spot to avoid payment.
...
#### Program Description
By opting into any DoublePark text messaging program, you expressly consent to receive text messages (SMS) to your mobile number. DoublePark text messages may include: account alerts and one time passcodes.

#### Message Frequency
Messages are sent only during account authentication, typically once per sign-in.
...
**7533 C Center View Ct Ste N**

**West Jordan, UT 84084**

**United States**

**Phone: 1-415-317-7661**

**doublepark.contact@gmail.com**
